...
\input{Configuration_Files/matlab}
...
\puttitle{
	title=Springs and BEM, % Title of the thesis
	...
	ID  = 243786,  % Student ID number (numero di matricola)
...
% --------------------------------------------------------------------------
\chapter{System of Nonlinear Springs}
\label{ch:chapter_one}%
% The \label{...}% enables to remove the small indentation that is generated, always leave the % symbol.
\input{Projects/project1.tex} \cleardoublepage

\chapter{Potential Problems with BEM}
\label{ch:chapter_two}%

\input{Projects/project2.tex} \cleardoublepage

% --------------------------------------------------------------------------

\input{Projects/to_be_erased.tex} \cleardoublepage
